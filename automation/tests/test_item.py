...
def test_navigate_via_name_standard_user(standard_user_session) -> None:
...
@pytest.mark.standard_user
def test_navigate_via_image_standard_user(standard_user_session) -> None:
...
@pytest.mark.standard_user
def test_item_name_correct_standard_user(standard_user_item_page) -> None:
    assert ItemPage(standard_user_item_page).get_item_name() == BACKPACK_NAME


@pytest.mark.standard_user
def test_item_description_present_standard_user(standard_user_item_page) -> None:
    assert ItemPage(standard_user_item_page).get_item_description() != ""


@pytest.mark.standard_user
def test_item_price_correct_standard_user(standard_user_item_page) -> None:
    assert ItemPage(standard_user_item_page).get_item_price() == BACKPACK_PRICE


@pytest.mark.standard_user
def test_item_image_correct_standard_user(standard_user_item_page) -> None:
    assert "sl-404" not in ItemPage(standard_user_item_page).get_item_image_src()


@pytest.mark.standard_user
def test_add_to_cart_increments_badge_standard_user(standard_user_item_page) -> None:
...
@pytest.mark.standard_user
def test_add_button_changes_to_remove_standard_user(standard_user_item_page) -> None:
    page = ItemPage(standard_user_item_page)
...
@pytest.mark.standard_user
def test_remove_decrements_badge_standard_user(standard_user_item_page) -> None:
    page = ItemPage(standard_user_item_page)
    page.click_add_remove_button()
    assert page.get_cart_badge_count() == 1
    page.click_add_remove_button()
...
@pytest.mark.standard_user
def test_remove_button_changes_to_add_standard_user(standard_user_item_page) -> None:
    page = ItemPage(standard_user_item_page)
    page.click_add_remove_button()
    assert page.get_button_text() == "Remove"
    page.click_add_remove_button()
...
@pytest.mark.standard_user
def test_back_to_products_standard_user(standard_user_item_page) -> None:
...
def test_item_links_route_incorrectly_problem_user(problem_user_session) -> None:
...
def test_price_mismatch_detail_vs_inventory_visual_user(visual_user_session) -> None:
...
@pytest.mark.visual_user
def test_detail_image_correct_visual_user(visual_user_session) -> None:
...
def test_add_non_functional_on_detail_error_user(error_user_item_page) -> None:
